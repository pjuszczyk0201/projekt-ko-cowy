        ...
        <ListItem dense button className="listItem">
            ...
            {productEdit === product.id ? (
                ...
                >
                 ...
                 <TiTickOutline onClick={() => editProduct(product.id)}/>
                ...
                <Checkbox
                    ...
                    disableRipple
                />
                <ListItemText className={product.completed ? "completed" : ''}> {name} {quantity} {unit}</ListItemText>
                <BiEditAlt onClick={() => setProductEdit(product.id)}/>
